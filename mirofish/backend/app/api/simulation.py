...
def start_simulation():
    ...
    请求（JSON）：
        {
            ...
            "max_active_agents": 10,               // 可选: 每轮最多激活的Agent数
    ...
    try:
        ...
        max_active_agents = data.get('max_active_agents')  # 可选：每轮最大激活Agent数
        ...
        if max_active_agents is not None:
            try:
                ...
                if max_active_agents <= 0:
                    return jsonify({
                        "success": False,
                        "error": "max_active_agents must be a positive integer"
                    }), 400
            except (ValueError, TypeError):
                return jsonify({
                    "success": False,
        ...
        if max_active_agents:
            response_data['max_active_agents_applied'] = max_active_agents
