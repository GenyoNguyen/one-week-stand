...
class SimulationRunner:
    ...
    def start_simulation(
        ...
        max_active_agents: int = None,  # 每轮最大激活Agent数
        ...
        Args:
            ...
            max_active_agents: 每轮最大激活Agent数（可选）
        ...
        try:
            ...
            if max_active_agents is not None and max_active_agents > 0:
                cmd.extend(["--max-active-agents", str(max_active_agents)])
