...
def get_active_agents_for_round(
    ...
    if max_active_agents is not None:
        target_count = min(target_count, max_active_agents)
...
async def main():
    ...
    if args.max_active_agents is not None:
        config["max_active_agents"] = args.max_active_agents
    ...
    if args.max_active_agents:
        log_manager.info(f"  - 每轮最大激活Agent数: {args.max_active_agents}")
